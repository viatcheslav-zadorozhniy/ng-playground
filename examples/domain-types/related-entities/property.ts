...
import { PopulatedRoom, Room } from './room';
 ...
 */
export interface Property extends BaseEditableEntity {
  name: string;
  rooms: Room['id'][];
}
 ...
 */
export interface PopulatedProperty extends Omit<Property, 'rooms'> {
  rooms: Array<Room | PopulatedRoom>;
}
