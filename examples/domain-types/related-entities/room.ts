...
import { PopulatedProperty, Property } from './property';
 ...
 */
export interface Room extends BaseEditableEntity {
  name: string;
 ...
 */
export interface PopulatedRoom extends Omit<Room, 'property'> {
  property: Property | PopulatedProperty;
}
